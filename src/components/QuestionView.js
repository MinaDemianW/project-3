...
const QestionView = ({ match }) => {
    ...
    const isAnswered = Boolean(question.optionOne.votes.find(vote => vote === authedUser))
    ...
    const authedUserVoteOptionOne = question.optionOne.votes.find(vote => vote === authedUser)
    const authedUserVoteOptionTwo = question.optionTwo.votes.find(vote => vote === authedUser)
